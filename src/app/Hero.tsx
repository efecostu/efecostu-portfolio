...
const LinkWithTooltip: React.FC<LinkWithTooltipProps> = ({
  ...
  return (
    <span className="relative inline-block">
      ...
      {isHovered && (
        <span className="absolute z-10 left-0 -bottom-24 w-64 p-3 shadow-lg bg-[var(--tooltip)] border border-[var(--tooltip-border)] rounded text-sm text-[var(--tooltip-foreground)]">
          {description}
...
const Hero: React.FC = () => {
  return (
    <div className="py-8 px-4 min-h-[50vh] flex flex-col items-start">
